...
description: >
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a orthopaedics
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a orthopaedics clinic/operation letter
  for follow-up disposition. Covers elective joint replacement (hip, knee), ACL reconstruction, foot-and-ankle (bunion, injections), shoulder arthroscopy, and hand pathways (Dupuytren's, ganglion, trigger digit, carpal tunnel, hand trauma). Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a orthopaedics patient's
  follow-up.
---

# FastPIFU — Orthopaedics

This skill decides what should happen next with a orthopaedics patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a orthopaedics document;
...
**Orthopaedics-specific hard rules:**

...
description: >
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a oral and maxillofacial surgery
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a oral and maxillofacial surgery clinic/operation letter
  for follow-up disposition. Covers OMFS surgical pathways (dentoalveolar surgery, jaw cysts, facial fractures, orthognathic osteotomy, skin lesions) and non-surgical oral-mucosal conditions, TMJ problems and myofascial pain. Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a oral and maxillofacial surgery patient's
  follow-up.
---

# FastPIFU — Oral and maxillofacial surgery

This skill decides what should happen next with a oral and maxillofacial surgery patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a oral and maxillofacial surgery document;
...
Common traps for oral and maxillofacial surgery:
...
**Oral and maxillofacial surgery-specific hard rules:**

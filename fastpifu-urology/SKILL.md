...
description: >
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a urology
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a urology clinic/operation letter
  for follow-up disposition. Covers benign urology conditions (stones, bladder-outlet obstruction, erectile dysfunction, LUTS/overactive bladder, bladder pain syndrome, pelvic floor disorders, long-term ISC, post-Peyronie's, recurrent UTI) and urological cancer remote-monitoring (bladder, prostate, kidney). Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a urology patient's
  follow-up.
---

# FastPIFU — Urology

This skill decides what should happen next with a urology patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a urology document;

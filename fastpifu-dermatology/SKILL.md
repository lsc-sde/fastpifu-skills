...
description: >
  Assess a dermatology patient for PIFU (Patient-Initiated Follow-Up) suitability from their
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a dermatology
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a dermatology clinic/operation letter
  for follow-up disposition. Covers skin cancers and pre-cancers (melanoma, cSCC, BCC, actinic keratosis, SCC in situ), multiple atypical moles, post-skin-lesion surgery, inflammatory skin disease, acne, isotretinoin and patch tests. Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a dermatology patient's
  follow-up.
---

# FastPIFU — Dermatology

This skill decides what should happen next with a dermatology patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a dermatology document;
...
**Dermatology-specific hard rules:**

...
description: >
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a spinal
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a spinal clinic/operation letter
  for follow-up disposition. Covers lumbar facet-joint (medial branch block) and nerve-root-block injections, posterior lumbar decompression/discectomy, and the adolescent idiopathic scoliosis pathway. Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a spinal patient's
  follow-up.
---

# FastPIFU — Spinal

This skill decides what should happen next with a spinal patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a spinal document;

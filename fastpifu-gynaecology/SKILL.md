...
description: >
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a gynaecology
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a gynaecology clinic/operation letter
  for follow-up disposition. Covers pelvic organ prolapse (conservative, pessary and surgical pathways). Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a gynaecology patient's
  follow-up.
---

# FastPIFU — Gynaecology

This skill decides what should happen next with a gynaecology patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a gynaecology document;
...
**Gynaecology-specific hard rules:**

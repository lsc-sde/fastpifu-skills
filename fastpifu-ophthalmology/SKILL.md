...
description: >
  ...
  confidence score and explicit reasoning. Use this whenever you need to screen a ophthalmology
  patient for PIFU, decide whether a patient can move to patient-initiated follow-up, be
  discharged, or must stay in timed follow-up, or process a ophthalmology clinic/operation letter
  for follow-up disposition. Covers cataract surgery, age-related macular degeneration (AMD), diabetic macular oedema (DMO) and glaucoma, including virtual/asynchronous review pathways. Reach for this skill even when the request
  doesn't say "PIFU" explicitly but asks what should happen next with a ophthalmology patient's
  follow-up.
---

# FastPIFU — Ophthalmology

This skill decides what should happen next with a ophthalmology patient who is **already in
...
read all first. If none is provided, ask for the letter. Confirm this is a ophthalmology document;
...
Common traps for ophthalmology:
...
**Ophthalmology-specific hard rules:**
